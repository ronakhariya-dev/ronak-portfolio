    ...
    projects: [
      {
        ...
        period: 'May 2026 – Present',
        description: 'Working within the Capital Markets domain undergoing domain onboarding and financial systems training, contributing to enterprise-scale technology solutions.',
        highlights: [
          'Working within the Capital Markets domain',
          'Undergoing domain onboarding and financial systems training',
          'Contributing to enterprise-scale technology solutions',
        ],
        tech: ['Java', 'Spring Boot', 'Capital Markets', 'Financial Systems'],
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        highlights: [
          'Designed and developed 5+ Spring Boot microservices (Loan, Beneficiary, Student Portal, Approval)',
          ...
          'Applied Circuit Breaker, API Gateway, Service Discovery, and centralized config',
